...
all_trips <- all_trips %>%  #this code lets us delete rows from the new database we are gonna make
  select(-c(start_lat, start_lng, end_lat, end_lng, birthyear, gender, "tripduration")) # we use the -c to remove columns
